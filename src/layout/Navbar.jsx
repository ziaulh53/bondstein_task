...
export const Navbar = () => {
  ...
  return (
    <div className="bg-white w-full border-b">
      <div className="max-w-[97%] md:max-w-[90%] mx-auto text-white">
        <div className="flex items-center justify-between py-3 md:py-4 lg:py-5 min-h-[60px]">
          ...
          <ul className="hidden lg:flex space-x-4 md:space-x-6 lg:space-x-8 font-ibm text-[#000000] text-[16px]">
            {menu.map(({ label, path }, idx) => (
              <li key={idx}>
                <Link
                  to={path}
                  className="hover:text-gray-300 text-[16px] transition-colors delay-100 font-medium"
                >
                  {label}
                </Link>
              </li>
          ...
          <div className="hidden lg:flex items-center space-x-4">
            ...
            <Link
              to="#"
              className="bg-theme rounded-3xl font-jakarta font-[700] border-2 border-theme text-white text-[14px] px-4 py-2 hover:bg-opacity-90 transition-colors delay-100"
            >
              Upload
            </Link>
            <Link
              to="#"
              className="bg-white rounded-3xl font-jakarta font-[700] text-theme border-2 border-theme text-[14px] px-3 py-2 hover:bg-opacity-90 transition-colors delay-100"
            >
              Connect Wallet
            </Link>
          </div>
          <div className="lg:hidden">
            ...
            >
              <div>
                ...
                <Link
                  to="#"
                  className="bg-[#4475F2] rounded-3xl font-jakarta font-[700] text-[#FFFFFF] text-[14px] px-5 py-2 hover:bg-opacity-90 transition-colors delay-100"
                >
                  Register / Login
                </Link>
              </div>
